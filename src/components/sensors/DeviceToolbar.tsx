...
import { Grid3X3, Circle, CircleDot, Search, PlusCircle } from "lucide-react";
...
interface DeviceToolbarProps {
  ...
  roleFilter?: "all" | "master" | "satellite";
  onRoleFilterChange?: (filter: "all" | "master" | "satellite") => void;
}
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <Button
              ...
              onClick={() => handleViewChange("grouped-dot")}
              title="Grouped Dot View"
            >
