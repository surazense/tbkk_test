...
export default function MobileDrawer({
  ...
  return (
    <>
      ...
      {/* Drawer Panel */}
      <div
        className={`md:hidden fixed top-0 left-0 z-50 h-full w-72 bg-[#0B1121] border-r-[1.35px] border-[#374151] flex flex-col transition-transform duration-300 ease-in-out ${
